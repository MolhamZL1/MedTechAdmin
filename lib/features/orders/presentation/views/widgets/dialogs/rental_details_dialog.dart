          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                Text(
                  'ORD-${order.id.toString().padLeft(3, '0')}', // Example: ORD-001
                  style: const TextStyle(
                    fontSize: 14.0,
  ...
  Widget _buildContent() {
    return Column(
      ...
      children: [
        ...
        const SizedBox(height: 24.0),
        EquipmentDetailsSection(order: order),
      ...
      children: [
        StatusBadge(
          status: order.status == "Processing"
              ? StatusType.active // Assuming 'active' for processing
              : StatusType.pending, // Default to pending if not processing
        ),
