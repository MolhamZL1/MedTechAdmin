  ...
  static TableData fromMaintenanceRequestList(
    ...
    final columns = [
      TableColumn(
        ...
        // ✅ 1. إزالة العرض الثابت (width) لجعله مرنًا
        // width: 250,
        customBuilder: (value) {
            ...
            children: [
              Row(
                children: [
                  ...
                  // ✅ 2. لف النص بويدجت Flexible ليأخذ المساحة المتاحة فقط
                  Flexible(
                    child: Text(
                      ...
                      // ✅ 3. إزالة overflow لأن النص سيلتف تلقائيًا
...
// ...
      ...
      TableColumn(
        ...
        customBuilder: (value) {
          final request = value as MaintenanceRequestEntity;
          final customerUsername = request.customer.username;
          final customerEmail = request.customer.email;
          ...
          return Row(
            children: [
              CircleAvatar(
                ...
                radius: 16,
                child: Text(
                  customerUsername.isNotEmpty ? customerUsername.substring(0, 1).toUpperCase() : '?',
            ...
            children: [
              Row(
                children: [
                  ...
                  Text(
                    'Preferred: ${_formatDate(request.preferredServiceDate)}',
      ...
      TableColumn(
        ...
        customBuilder: (value) {
          final request = value as MaintenanceRequestEntity;
          return StatusBadge(status: _getStatusType(request.status));
        },
      ),
      TableColumn(
        key: 'actions',
  ...
  // في ملف: MaintenanceRequestTableHelper.dart

  static void _showAssignTechnicianDialog(
      BuildContext context, MaintenanceRequestEntity request) {
    // ✅✅✅ 1. إمساك الـ Cubits من الـ context الأصلي قبل بناء الديالوغ ✅✅✅
    final userCubit = context.read<UserCubit>()..fetchUsers();
    final maintenanceCubit = context.read<MaintenanceRequestCubit>(); // <--- هنا
        ...
        return StatefulBuilder(
          builder: (context, setState) {
            return AlertDialog(
              ...
              content: BlocProvider.value( // ✅ 2. توفير UserCubit للديالوغ
                value: userCubit,
                      ...
                      return Form(
                        ...
                        child: SingleChildScrollView(
                          child: Column(
                            mainAxisSize: MainAxisSize.min,
                            children: [
                              // ... (DropdownButtonFormField يبقى كما هو)
                              ...
                              // ... (TextFormField للتاريخ يبقى كما هو)
                              TextFormField(
                                readOnly: true,
                              ...
                              const SizedBox(height: 16),
                              // ... (TextFormField للتكلفة يبقى كما هو)
                              TextFormField(
                ...
                ElevatedButton(
                  onPressed: () {
                    if (formKey.currentState!.validate()) {
                      // ✅✅✅ 3. استخدام الـ Cubit الذي تم تمريره مباشرة ✅✅✅
  ...
  static StatusType _getStatusType(String status) {
    switch (status.toUpperCase()) {
      ...
      case 'IN_PROGRESS': return StatusType.active;
